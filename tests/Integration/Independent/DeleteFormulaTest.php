...
final class DeleteFormulaTest extends IndependentOrmTestCase
{
    public function testDqlDeleteWhereFormulaField(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.orderCount >= :min'
        )
            ->setParameter('min', 2)
            ->execute();
    ...
    public function testDqlDeleteWhereBetween(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.orderCount BETWEEN :min AND :max'
        )
            ->setParameter('min', 1)
            ->setParameter('max', 2)
            ->execute();
    ...
    public function testDqlDeleteWhereIn(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.orderCount IN (:counts)'
        )
    ...
    public function testDqlDeleteWhereNotIn(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.orderCount NOT IN (:counts)'
        )
            ->setParameter('counts', [1, 3])
            ->execute();
    ...
    public function testDqlDeleteWhereIsNull(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.maxItemPrice IS NULL'
        )
            ->execute();
    ...
    public function testDqlDeleteWhereIsNotNull(): void
    {
        ...
        $affected = $this->em->createQuery(
            'DELETE ' . Product::class . ' p WHERE p.maxItemPrice IS NOT NULL'
        )
            ->execute();
