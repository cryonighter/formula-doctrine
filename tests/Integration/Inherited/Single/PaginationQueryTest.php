...
final class PaginationQueryTest extends SingleInheritedOrmTestCase
{
    /**
    ...
    public function testFindPagination(): void
    {
        ...
        $resultOne = $this->em->getRepository(FormulaSingleProduct::class)
            ->findBy([], [], $limit, $offset);
        ...
        $resultTwo = $this->em->getRepository(FormulaSingleProduct::class)
