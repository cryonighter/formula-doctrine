...
final class OrderByFormulaTest extends SingleInheritedOrmTestCase
{
    public function testDqlOrderByAsc(): void
    {
        ...
        $products = $this->em->createQuery('SELECT p FROM ' . FormulaSingleProduct::class . ' p ORDER BY p.orderCount ASC')
            ->getResult();
    ...
    public function testDqlOrderByDesc(): void
    {
        ...
        /** @var FormulaSingleProduct[] $products */
        $products = $this->em->createQuery('SELECT p FROM ' . FormulaSingleProduct::class . ' p ORDER BY p.orderCount DESC')
            ->getResult();
    ...
    public function testDqlOrderByWithWhereCondition(): void
    {
        ...
        $products = $this->em->createQuery(
            'SELECT p FROM ' . FormulaSingleProduct::class . ' p WHERE p.orderCount >= :minCount ORDER BY p.totalRevenue DESC'
        )
        ...
        // The totalRevenue field formula appears only: in the SELECT statement
        // The ORDER BY statement must use the alias from the first SELECT statement
