...
use Cryonighter\FormulaDoctrine\Tests\Integration\Inherited\Single\Fixture\Entity\Category;

final class FormulaInFormulaTest extends SingleInheritedOrmTestCase
{
    /**
