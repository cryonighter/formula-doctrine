...
final class HavingFormulaTest extends SingleInheritedOrmTestCase
{
    ...
    public function testDqlHavingWithExistsSubquery(): void
    {
        ...
        $result = $this->em->createQuery(
            ...
            'GROUP BY p.orderCount ' .
            'HAVING EXISTS (' .
            '    SELECT 1 FROM ' . FormulaSingleProduct::class . ' p2 ' .
    ...
    public function testDqlHavingWithScalarSubquery(): void
    {
        ...
        $result = $this->em->createQuery(
            ...
            '    SELECT AVG(p2.totalRevenue) FROM ' . FormulaSingleProduct::class . ' p2' .
            ') ' .
            'ORDER BY p.orderCount ASC'
        )
            ->getResult();
