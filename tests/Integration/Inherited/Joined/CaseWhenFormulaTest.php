...
final class CaseWhenFormulaTest extends JoinedInheritedOrmTestCase
{
    ...
    public function testDqlCaseWhenWithSubquery(): void
    {
        ...
        $result = $this->em->createQuery(
            ...
            '    WHEN p.totalRevenue > (SELECT AVG(p2.totalRevenue) FROM ' . FormulaJoinedProduct::class . ' p2) THEN \'above_avg\' ' .
            '    ELSE \'below_avg\' ' .
    ...
    public function testDqlCaseWhenWithCompoundCondition(): void
    {
        ...
        $result = $this->em->createQuery(
            'SELECT p.name, p.totalRevenue, ' .
            'CASE ' .
            '    WHEN p.totalRevenue > (SELECT AVG(p2.totalRevenue) FROM ' . FormulaJoinedProduct::class . ' p2) AND p.orderCount > 0 THEN \'above_avg_active\' ' .
    ...
    public function testDqlCaseWhenWithExistsSubquery(): void
    {
        ...
        $result = $this->em->createQuery(
            'SELECT p.name, p.totalRevenue, ' .
            'CASE ' .
            '    WHEN EXISTS (SELECT 1 FROM ' . FormulaJoinedProduct::class . ' p2 WHERE p2.id = p.id AND p2.orderCount > 0) THEN \'active\' ' .
            '    ELSE \'inactive\' ' .
    ...
    public function testDqlCaseWhenWithNotExistsSubquery(): void
    {
        ...
        $result = $this->em->createQuery(
            'SELECT p.name, p.totalRevenue, ' .
            'CASE ' .
            '    WHEN NOT EXISTS (SELECT 1 FROM ' . FormulaJoinedProduct::class . ' p2 WHERE p2.id = p.id AND p2.orderCount > 0) THEN \'no_orders\' ' .
    ...
    public function testDqlCaseWhenWithSubqueryInOrderBy(): void
    {
        ...
        $result = $this->em->createQuery(
            ...
            'FROM ' . FormulaJoinedProduct::class . ' p ' .
            'ORDER BY CASE ' .
            '    WHEN p.totalRevenue > (SELECT AVG(p2.totalRevenue) FROM ' . FormulaJoinedProduct::class . ' p2) THEN 0 ' .
            '    ELSE 1 ' .
    ...
    public function testDqlCaseWhenInJoin(): void
    {
        ...
        // The JOIN statement must use the alias from the first SELECT statement
        self::assertCountFormulaSubqueries(1, $mainSql, $formulaOrderCount);
    ...
    public function testDqlCaseWhenWithSubqueryInJoin(): void
    {
        ...
        $result = $this->em->createQuery(
            ...
            '    AND CASE WHEN p.orderCount > 0 THEN p.totalRevenue ELSE 0 END > (SELECT AVG(p2.totalRevenue) FROM ' . FormulaJoinedProduct::class . ' p2) ' .
            'ORDER BY p.totalRevenue DESC'
        )
            ->getResult();
