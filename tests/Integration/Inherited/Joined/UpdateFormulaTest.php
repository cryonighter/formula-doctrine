...
final class UpdateFormulaTest extends JoinedInheritedOrmTestCase
{
    public function testDqlUpdateWhereFormulaField(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.orderCount >= :min'
        )
            ->setParameter('newName', 'Updated')
            ->setParameter('min', 2)
            ->execute();

        // Exactly 4 query — inherited UPDATE is performed by writing to a temporary table, this takes 4 queries
        self::assertCount(4, $this->queryLogger->getQueries());
    ...
    public function testDqlUpdateWhereBetween(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.orderCount BETWEEN :min AND :max'
        )
            ->setParameter('newName', 'Updated')
            ->setParameter('min', 1)
            ->setParameter('max', 2)
    ...
    public function testDqlUpdateWhereIn(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.orderCount IN (:counts)'
        )
            ->setParameter('newName', 'Updated')
    ...
    public function testDqlUpdateWhereNotIn(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.orderCount NOT IN (:counts)'
        )
            ->setParameter('newName', 'Updated')
            ->setParameter('counts', [1, 3])
            ->execute();
    ...
    public function testDqlUpdateWhereIsNull(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.maxItemPrice IS NULL'
        )
            ->setParameter('newName', 'Updated')
            ->execute();
    ...
    public function testDqlUpdateWhereIsNotNull(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName WHERE p.maxItemPrice IS NOT NULL'
        )
            ->setParameter('newName', 'Updated')
            ->execute();
    ...
    public function testDqlUpdateWhereExists(): void
    {
        ...
        $affected = $this->em->createQuery(
            'UPDATE ' . FormulaJoinedProduct::class . ' p SET p.name = :newName ' .
